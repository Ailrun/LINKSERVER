...
function addBoxUsr(req, res, next){
    //invit is omitted (invitingUsrKey, invitedUsrID, ...)
    var ingUsrKey = req.params.usrKey;
    var ingBoxKey = req.params.boxKey;
    var edUsrID = req.body.usrID;
    var queryParams = [ingUsrKey, ingBoxKey, ingUsrKey, ingBoxKey, edUsrID];
