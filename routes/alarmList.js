...
const alarmAllListQuery = ("SELECT A.alarmKey, A.alarmDate, A.hidden, Us.usrName alarmSetUsrName, A.alarmBoxKey, BofU.boxName alarmBoxName, A.alarmUrlKey alarmUrlKey, Ur.urlTitle alarmUrlTitle, A.alarmMessage alarmMessage\
...
const alarmHiddenListQuery = ("SELECT A.alarmKey, A.alarmDate, Us.usrName alarmSetUsrName, A.alarmBoxKey, BofU.boxName alarmBoxName, A.alarmUrlKey alarmUrlKey, Ur.urlTitle alarmUrlTitle, A.alarmMessage alarmMessage\
                              FROM alarmList A JOIN boxOfUsrList BofU ON BofU.boxKey=A.alarmBoxKey JOIN usrList Us ON Us.usrKey=A.alarmSetUsrKey\
